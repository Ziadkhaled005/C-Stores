...
export function AuditLogPage() {
    ...
    const filtered = logs.filter((log) => {
        if (filterModule !== "الكل" && log.module !== filterModule)
            return false;
        if (filterBranch !== "الكل" && log.branchName !== filterBranch)
            return false;
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 mb-5">
                {[
                    ...
                    },
                    {
                        ...
                        value: logs.filter((l) => l.action === "تسجيل دخول")
                            .length,
                        color: "text-green-600",
                    },
                    {
                        label: "تغييرات المخزون",
                        value: logs.filter((l) => l.module === "المخزون")
                            .length,
                        color: "text-orange-600",
                    },
                    {
                        label: "تغييرات الصلاحيات",
                        value: logs.filter((l) => l.module === "الأدوار")
                            .length,
                    ...
                    <div
                        ...
                        <div className={`text-xl font-black mb-1 ${s.color}`}>
                            {s.value}
                        </div>
                            ...
                            {filtered.length === 0 ? (
                                ...
                                filtered.map((log) => (
                                    <tr
                                        ...
                                        <td className="px-4 py-3">
                                            <span
                                                className={`px-2 py-0.5 rounded-lg text-xs font-semibold ${MODULE_COLORS[log.module] ?? "bg-gray-100 text-gray-600"}`}>
                                                {log.module}
                                            </span>
                                        </td>
                                        <td className="px-4 py-3 text-gray-500 max-w-56 truncate">
                                            {log.details}
                                        </td>
