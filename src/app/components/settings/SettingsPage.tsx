...
export function SettingsPage() {
    ...
    useEffect(() => {
        ...
        const load = async () => {
            try {
                const [companySettings, taxSettingsRes, apiBranches, apiUsers] =
                    await Promise.all([
                        getSettingsCompany(),
                        getSettingsTax(),
                        getBranches(),
        ...
        try {
            if (editingUser) {
                ...
                const normalized = {
                    ...
                    password:
                        updated?.password ?? userForm.password ?? "123456",
                    phone: updated?.phone ?? userForm.phone ?? "",
                    avatar: updated?.avatarUrl ?? "",
                    branchId: updated?.branchId ?? null,
                };
                setUsers((us) =>
                    us.map((u) => (u.id === editingUser.id ? normalized : u)),
                );
            } else {
                ...
                const normalized = {
                    ...
                    password:
                        created?.password ?? userForm.password ?? "123456",
            ...
            if (editingUser) {
                ...
                setUsers((us) => [
                    ...us,
                    {
                        ...
                        name: userForm.name!,
                        email: userForm.email!,
                        role: (userForm.role as Role) || "cashier",
                        password: userForm.password || "123456",
                        phone: userForm.phone || "",
                    },
                ]);
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-sm transition-all ${
                            saved
                                ...
                                : "bg-gradient-to-l from-[#7C3AED] to-[#A855F7] text-white shadow-lg shadow-purple-500/30 hover:opacity-90"
                        }`}>
                        <Save size={16} />
                                ...
                                {[
                                    {
                                        ...
                                        key: "name",
                                        placeholder: "سي تكنولوجي ستور",
                                    },
                                    {
                                        label: "اسم الشركة (إنجليزي)",
                                        key: "nameEn",
                                        placeholder: "C Technology Store",
                                    },
                                    {
                                        label: "العنوان",
                                        key: "address",
                                    ...
                                    <div
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span
                                                    className={`text-xs px-2 py-0.5 rounded-lg font-semibold ${b.isActive ? "bg-green-100 text-green-700" : "bg-red-100 text-red-500"}`}>
                                                    {b.isActive
                                                        ? "نشط"
                                                        : "معطل"}
                                                </span>
                            ...
                            <div className="space-y-5">
                                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                    <div>
                                        ...
                                        <div className="text-xs text-gray-400 mt-0.5">
                                            إضافة ضريبة القيمة المضافة على
                                            الفواتير
                                        </div>
                                    </div>
                                    <button
                                        ...
                                        <span
                                            className={`block w-5 h-5 rounded-full bg-white shadow mx-0.5 transition-transform ${taxSettings.taxEnabled ? "translate-x-6" : "translate-x-0"}`}
                                        />
                                    </button>
                                </div>
                                ...
                                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                                    ...
                                    <button
                                        ...
                                        <span
                                            className={`block w-5 h-5 rounded-full bg-white shadow mx-0.5 transition-transform ${taxSettings.taxIncluded ? "translate-x-6" : "translate-x-0"}`}
                                        />
                                    </button>
                                </div>
                                ...
                                <div className="p-4 bg-blue-50 rounded-xl text-sm text-blue-700">
                                    <strong>ملاحظة:</strong> نسبة ضريبة القيمة
                                    المضافة المطبقة في مصر هي ١٤٪ وفقاً للقانون
                                    المصري.
                                </div>
                            </div>
                        </div>
                    ...
                    {tab === "invoice" && (
                        <div>
                            ...
                            {[
                                ...
                                {
                                    key: "showTax",
                                    label: "إظهار تفاصيل الضريبة",
                                },
                                { key: "showQR", label: "إظهار رمز QR" },
                            ].map((s) => (
                                <div
                                    key={s.key}
                                    className="flex items-center justify-between p-4 bg-gray-50 rounded-xl mb-3">
                                    ...
                                    <button
                                        ...
                                        <span
                                            className={`block w-5 h-5 rounded-full bg-white shadow mx-0.5 transition-transform ${(invoiceSettings as any)[s.key] ? "translate-x-6" : "translate-x-0"}`}
                                        />
                                    </button>
                                </div>
                            ))}
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                {users.map((u) => (
                                    <div
                                        key={u.id}
                                        className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-100 hover:border-purple-200 transition-all">
                                        ...
                                        <span
                                            className={`px-3 py-1 rounded-xl text-xs font-bold ${ROLE_COLOR[u.role]}`}>
                                            {ROLE_LABELS[u.role]}
                                        </span>
                                        <div className="flex items-center gap-2">
                                            <button
                                                onClick={() => openEditUser(u)}
                                                className="p-2 hover:bg-white rounded-xl text-gray-400 hover:text-[#7C3AED] transition-all">
                                                <Edit2 size={14} />
                                            </button>
                                            <button
                        ...
                        <div className="p-5 space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={inputCls}
                                    placeholder="employee@ctech.com"
                                />
                            </div>
                            <div>
                                <label className="block text-sm font-semibold text-gray-600 mb-1.5">
